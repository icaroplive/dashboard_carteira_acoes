var app = angular.module("app", ["ngRoute", "angularUtils.directives.dirPagination", "angular-loading-bar", "ngFileSaver", "chart.js"]);
app.config(function ($routeProvider) {
  $routeProvider
    ...
    .when("/movimentoacao", {
      templateUrl: "views/movimentoacao.view.html",
      controller: "movimentoacaoCtrl"
    })
    .when("/movimentoopcao", {
      templateUrl: "views/movimentoopcao.view.html",
      controller: "movimentoopcaoCtrl"
    })
    .when("/dashboard", {
