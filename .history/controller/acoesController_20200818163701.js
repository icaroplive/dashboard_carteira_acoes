...
app.controller('planosCtrl',['$scope','$http','api',function($scope,$http,api){
	...
	function save(form) {
		$http.post(api.url + '/planos', form).then(function (data) {
			var ew = {
				cliente: {},
				canal: null
			};
	...
	function update(form) {
		$http.put(api.url + '/planos', form).then(function (data) {
			console.log(data);
